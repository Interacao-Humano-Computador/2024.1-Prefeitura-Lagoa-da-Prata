...
| Ator       | Um médico                                                                                                                                                                                                                      |
| Episódios  | - O usuário acessa o site <br> - O usuário clica em "Serviços para o Cidadão" <br> - O usuário clica em "Lista de medicamentos disponíveis" <br> - O usuário encontra informações que estava buscando sobre o medicamento <br> |
