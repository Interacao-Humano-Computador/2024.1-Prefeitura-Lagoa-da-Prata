...
| **Habilidades**     | Maria Arlete pouca habilidade de navegação na internet e tem bastante dificuldade em atingir objetivos já que não está habituada a usar outras aplicações além do WhatsApp.                                                                                             |
