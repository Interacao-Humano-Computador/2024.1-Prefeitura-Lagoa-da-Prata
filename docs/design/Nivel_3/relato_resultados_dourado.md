...
## Objetivo 
O objetivo deste documento é relatar os resultados obtidos na avaliação do protótipo de alta fidelidade com relação a tarefa de "Solicitação de vistoria de local com água parada", realizado pelo integrante do grupo [Pedro Lucas](https://github.com/lucasdray).
...
| 2   | Ele atinge seu objetivo? Com quanta eficiência? Em quanto tempo? Após cometer quantos erros? | SIM <br> 100% DE EFICIÊNCIA <br>  EM 35 SEGUNDOS <br> 0 ERROS COMETIDO | Usuário  já possuia experiência com o site de Prefeituras e da Prefeitura Municipal de Lagoa da Prata |
| 3   | Ele entendeu o que deveria ser feito em seguida?                                             | SIM                                                                    | -                                                                                                     |
| 4   | Quais barreiras o usuário encontrou ao atingir seus objetivos?                               | NENHUMA                                                                | -                                                                                                     |
| 5   | Quantas vezes os usuários consultaram a ajuda para realizar uma ação?                        | NENHUMA                                                                | -                                                                                                     |
