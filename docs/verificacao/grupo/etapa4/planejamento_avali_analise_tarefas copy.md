...
<center>
Vídeo 01 - Inspeção e Verificação do Artefato Planejamento da avaliação do Storyboard
...
|  4  |         No artefato, todas as tabelas e imagens são chamadas no texto, possuem legendas e fontes seguindo a norma ABNT?         |     SIM     |      Possue apenas tabelas      |
