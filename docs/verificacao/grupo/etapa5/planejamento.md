...
O objetivo deste documento é apresentar o planejamento para a verificação dos artefatos produzidos na etapa 5 pelo [grupo 05](https://interacao-humano-computador.github.io/2024.1-Prefeitura-Lagoa-da-Prata/).
...
| :---------------------------------------------------------------------------------------------------------------------------: | :----: | :------------: | :-----------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: |
|          [Planejamento da avaliação do protótipo de papel](../../../design/Nivel_2/prototipo_papel/Pl_avaliacao.md)           | `1.1`  |   03/06/2024   | [Cainã Freitas](https://github.com/freitasc) e [Lucas Meireles](https://github.com/Katuner) | [Lucas Meireles](https://github.com/Katuner) e [Pedro Lucas](https://github.com/lucasdray) |
| [Planejamento do relato de resultados do protótipo de papel](../../../design/Nivel_2/prototipo_papel/Pl_relato_resultados.md) | `1.0`  |   03/06/2024   |                        [Cainã Freitas](https://github.com/freitasc)                         |                                             -                                              |
...
Os responsáveis por esse planejamento foram os integrantes [Augusto Duarte](https://github.com/Augcamp) e [Pedro Lucas](https://github.com/lucasdray). Já os integrantes responsáveis pela verificação dos checklists estão devidamente descritos na tabela 02 abaixo, tal como o artefato que será verificado.
<center>
...
| ----------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- | --------------------------------------------- |
| [Planejamento da avaliação do protótipo de papel](../../../design/Nivel_2/prototipo_papel/Pl_avaliacao.md)                    | [Pedro Lucas](https://github.com/lucasdray)  | [Cainã Freitas](https://github.com/freitasc)  |
| [Planejamento do relato de resultados do protótipo de papel](../../../design/Nivel_2/prototipo_papel/Pl_relato_resultados.md) | [Augusto Duarte](https://github.com/Augcamp) | [Pedro Lucas](https://github.com/lucasdray)   |
...
A tabela 04 a seguir apresenta a checklist referente ao artefato Planejamento da Avaliação do Protótipo de papel:
<center>

**Tabela 04** - Checklist do Planejamento da Avaliação do Protótipo de papel
...
A tabela 05 a seguir apresenta a checklist referente ao artefato Planejamento do relato de resultados do protótipo de papel:
<center>

**Tabela 05** - Checklist Planejamento do relato de resultados do protótipo de papel 
...
| 23/06/2024 | `1.1`  | Adição planejamento de avaliação | [Pedro Lucas](https://github.com/lucasdray)  |   25/06/2024    | [Augusto Duarte](https://github.com/Augcamp) |
| 25/06/2024 | `1.2`  |        Adição referencias        | [Augusto Duarte](https://github.com/Augcamp) |   26/06/2024    | [Pedro Lucas](https://github.com/lucasdray)  |
