...
### Persona X - Responsável da persona

Aqui serão dispostos os resultados da verificação do artefato ["Personas"](../../../requisitos1/personas.md), com direcionamento à persona "NOME PERSONA", proposta pelo membro [NOME](github), feitos pelo integrante [NOME](https://github.com/) conforme o [planejamento da verificação](planejamento.md).
...
**Vídeo 1** - Gravação da inspeção da "Persona" - NOME PERSONA.
