...
O objetivo desse documento é apresentar a metodologia adotada, os autores, o checklist do artefato ["Entrevista"](../../../requisitos1/entrevista.md) produzido e seus respectivos resultados, conforme descritos no [planejamento](planejamento.md). 
...
| :----------------------: | :-----------------: | :---------------------------: |  :-------------------:    |
| [Entrevista](../../../requisitos1/entrevista.md)            | [Augusto Duarte](https://github.com/Augcamp) | [Lucas Meireles](https://github.com/Katuner)  |     26/06/2024       |
...
Aqui serão dispostos os resultados da verificação do artefato ["Entrevista"](../../../requisitos1/entrevista.md), feitos pelo integrante [Lucas Meireles](https://github.com/Katuner) conforme o [planejamento da verificação](planejamento.md).

#### Inspeção

Abaixo se encontra o Vídeo 1, referente à inspeção realizada ao artefato ["Entrevista"](../../../requisitos1/entrevista.md).

<center>

**Vídeo 1** - Gravação da inspeção da "Entrevista".
...
A tabela 3 abaixo apresenta a checklist proposta pelo integrante [Augusto Duarte](https://github.com/Augcamp) durante o [planejamento da verificação](planejamento.md) com suas verificações e observações feitas pela inspeção do integrante [Lucas Meireles](https://github.com/Katuner).

<center>

**Tabela 3** - Cheklist Entrevista
