...
**Vídeo 1** - Gravação da inspeção do "--".
...
Abaixo se encontra o Vídeo 2, referente à inspeção realizada ao artefato ["Entrevista"](../../../requisitos1/entrevista.md).

<center>

**Vídeo 2** - Gravação da inspeção da "Entrevista".
...
A tabela 4 abaixo apresenta a checklist proposta pelo integrante [Augusto Duarte](https://github.com/Augcamp) durante o [planejamento da verificação](planejamento.md) com suas verificações e observações feitas pela inspeção do integrante [Lucas Meireles](https://github.com/Katuner).

<center>

**Tabela 04** - Checklist "Questionário"

| ID  | Descrição                                                                                                            | Avaliação | Referência            | Imagem         |
| :-: | -------------------------------------------------------------------------------------------------------------------- | --------- | --------------------- | -------------- |

*Fonte: [--](https://github.com/). 2024*
