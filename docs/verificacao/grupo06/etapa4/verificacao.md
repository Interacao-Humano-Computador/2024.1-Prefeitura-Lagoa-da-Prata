# Verificação da Etapa 4 do Grupo 6
...
|  8  | O planejamento trata do teste piloto? (cronograma, participantes, resultado) |     INCOMPLETO     |      Não mostra os membros responsáveis por cada entrevista |
