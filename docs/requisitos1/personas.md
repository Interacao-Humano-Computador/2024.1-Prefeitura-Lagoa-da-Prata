...
| **Descrição**       | Diego Lima, 23 anos, morador de Lagoa da Prata. Homem. Solteiro. Conseguiu uma vaga inicial para trabalhar na área de eventos da prefeitura.                                                                                                                                                                     |
| **Status**          | Persona Primária.                                                                                                                                                                                                                                                  |
| **Objetivos**       | Diego quer ter um bom desempenho durante seu serviço para que consiga cargos melhores e com mais impacto na sociedade. Ele busca conscientizar pessoas sobre cultura e arte.                                                                                                      |
| **Habilidades**     | Diego tem habilidades avançadas de navegação na internet e possui experiência com a divulgação de eventos em mídias sociais. Ele também reconhece e consegue lidar com aspectos burocráticos de seu emprego na prefeitura.                                                                                                          |
| **Tarefas**         | Diego acessa o site da prefeitura para verificar os eventos postados no site e realiza atualizações das notícias. Ele também é responsável por verificar as caixasde email de contato com a secretaria de eventos para que repasse aos funcionários necessários para aprovação ou não de um evento, assim como mudanaçs necessárias antes que possa produzir uma imagem para então atualizar o site da prefeitura com o mesmo. |
| **Relacionamentos** | Diego possui contato frequente com seus colegas de serviço e artistas da cidade. Ele conhece grupos e sempre está em contato com pessoas que atuam na área de auxílio social e das escolas da cidade.                              |
| **Requisitos**      | Receber as informações de um evento, confirmar os dados e a viabilidade, gerar uma imagem de publicação, repassar as informações do evento e criar uma postagem no site da prefeitura.                                                                                                                                                                                                                     |
| **Expectativas**    | Diversas informações em uma mesma página, praticidade em selecionar tipo de evento, local, horário e preencher informações extras, resposa rápida dos superiores e dos interessados em realizar um evento, interação com o público alvo do evento.                                                                                                                                                           |
...
| **Descrição**       | Maria Arlete, 43 anos, moradora de Lagoa da Prata. Mulher. Casada. Mãe de 2 adolescentes.                                                                                                                                                                                            |
| **Status**          | Persona Primária.                                                                                                                                                                                                                                                                |
| **Objetivos**       | Maria Arlete é socia de uma empreiteira junto de seu marido por isso está sempre acompanhando as oportunidades de negócios na cidade. Ela é consciente da importância de se manter atualizada sobre as licitações disponíveis para explorar novas oportunidades de trabalho ou negócios.      |
| **Habilidades**     | Maria Arlete possui habilidades básicas de navegação na internet, mas tem dificuldades em gerar relatórios específicos em formato CSV. Ela está familiarizada com aplicativos comuns, como WhatsApp e redes sociais, mas tem menos experiência com ferramentas de produtividade. |
| **Tarefas**         | Maria Arlete precisa acessar o site da prefeitura regularmente para obter informações sobre licitações disponíveis e gerar relatórios em formato CSV para análise e acompanhamento. Ela também precisa manter-se atualizada sobre as últimas notícias e eventos da cidade.       |
| **Relacionamentos** | Maria Arlete mantém um círculo social relativamente amplo, incluindo amigos, familiares e colegas de trabalho. Ela valoriza esses relacionamentos para troca de informações e apoio mútuo. Sua vida é equilibrada entre as responsabilidades familiares e profissionais.         |
| **Requisitos**      | Gerar relatórios das licitações disponíveis em formato CSV a partir do site da prefeitura.                                                                                                                                                                                       |
| **Expectativas**    | Espera obter relatórios precisos e atualizados das licitações disponíveis, com instruções claras sobre como acessá-las e baixá-las em formato CSV. Deseja uma interface de site intuitiva e fácil de usar, adequada para pessoas com habilidades de navegação básicas.           |
